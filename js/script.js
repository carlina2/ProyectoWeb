...
document.addEventListener("DOMContentLoaded", function() {
    const btn = document.querySelector(".acordeon-btn");
    const contenido = document.querySelector(".acordeon-contenido");
...
document.addEventListener("DOMContentLoaded", function() {
    const btn = document.querySelector(".acordeon-btn1");
    const contenido = document.querySelector(".acordeon-contenido1");
